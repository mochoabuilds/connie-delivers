...
extension UIColor {
    ...
    static let mainBlueTint = UIColor.rgb(red: 18, green: 155, blue: 236)
}
...
extension UIView {
    ...
    // Centering Views Within Other Views
...
extension MKMapView {
    func ZoomToFit(annotations: [MKAnnotation]) {
        ...
        // func called because we cannot change zoom view in emerging bottom view
